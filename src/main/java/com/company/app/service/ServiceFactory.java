...
public class ServiceFactory {
    ...
    private ServiceFactory() {
        map = new HashMap<>();
        map.put(ClientService.class, new ClientServiceImpl(DaoFactory.getInstance().getDao(ClientDao.class), ConverterFactory.getInstance().getConverter(ClientConverter.class), DigestUtil.getInstance()));
